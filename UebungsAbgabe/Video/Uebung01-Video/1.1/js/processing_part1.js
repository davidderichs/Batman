...
function mainPlayer(){
        ...
        case "u0.2": 
            ...
            break; 
		case "u1.1": 
			setMainVideoPlayer(720,404,processingVideoGenColourArea);  // L�sung 1.1
			setImputFields("visible","visible","R (0-255): ","235", "visible","visible","G: ","235", "visible","visible","B: ","235");
            break; 
        case "u1.2": 
            setMainVideoPlayer(display_fac,display_fac,processingVideoGray); // L�sung 1.1
		...
		case "u2.1": 
            ...
            break; 
        case "u2.2": 
			setMainVideoPlayer(display_fac,display_fac,processingVideoBridnessContrast);     //l�sung  2.1
			setImputFields("visible","visible","Contrast (dB): ","-6", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(videoPlayer, videoFile, picFile);
            break; 
	    case "u2.3": 
			setMainVideoPlayer(display_fac,display_fac,processingVideoChromaKeying); //l�sung  2.1		
		...
		case "u3.1": 
			...
			break  			
		case "u3.2": 
			setMainVideoPlayer(display_fac,display_fac,processingVideoKompDelta); //l�sung  3.1 
            ...
            break  	
		case "u3.3": 
			setMainVideoPlayer(8,1,processingVideoGenKompSubband); //l�sung  3.1 
            ...
            break  	
		case "u3.4": 
			setMainVideoPlayer(display_fac,display_fac,processingVideoKompSubband); //l�sung  3.1 
            ...
            break  		
		case "u3.5": 
			setMainVideoPlayer(4,4,processingVideoGenKompFFTOneHz); setInitFFT(4);//l�sung  3.1 
			...
			break  	
		case "u3.6": 
			setMainVideoPlayer(4,4,processingVideoGenKompFFTpic); setInitFFT(4);//l�sung  zusatz ?3.1 
            ...
            break  	
		case "u3.7": 
			setMainVideoPlayer(display_fac,display_fac,processingVideoKompFFT); setInitFFT(display_fac);//l�sung  3.1 
            ...
            break  	
		case "u4.1": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo41); //l�sung  3.1 
			...
			break  			
		case "u4.2": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo42); //l�sung  3.1 
            ...
            break  
		case "u4.3": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo43); setInitFFT(display_fac);//l�sung  3.1 
            ...
            break  
		case "u4.4": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo44); //l�sung  3.1 
            ...
            break  		
		case "u4.5": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo45); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,..255. , off: 5555): ","3", "visible","visible","MP1 + Mp2-Quant-Faktor: ","2","visible","visible","HP-Quant-Faktor: ","1");
			setImputFields4("visible","visible","Gain Sumant: ","100");
			loadPlayer(videoPlayer, videoFile, picFile);
			break  	
		case "u4.6": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo46); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,..255. , off: 5555): ","3", "visible","visible","MP1 + Mp2-Quant-Faktor: ","2","visible","visible","HP-Quant-Faktor: ","1");
			setImputFields4("visible","visible","Gain Sumant: ","100");
			loadPlayer(videoPlayer, videoFile, picFile);
            break  	
		case "u4.7": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo47); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,..255. , off: 5555): ","3", "visible","visible","MP1 + Mp2-Quant-Faktor: ","2","visible","visible","HP-Quant-Faktor: ","1");
			setImputFields4("visible","visible","Gain Sumant: ","100");
			loadPlayer(videoPlayer, videoFile, picFile);
            break 
		case "u4.8": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo48); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,..255. , off: 5555): ","3", "visible","visible","MP1 + Mp2-Quant-Faktor: ","2","visible","visible","HP-Quant-Faktor: ","1");
			setImputFields4("visible","visible","Gain Sumant: ","100");
			loadPlayer(videoPlayer, videoFile, picFile);
            break 
		case "u4.9": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo49); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,..255. , off: 5555): ","3", "visible","visible","MP1 + Mp2-Quant-Faktor: ","2","visible","visible","HP-Quant-Faktor: ","1");
			setImputFields4("visible","visible","Gain Sumant: ","100");
			loadPlayer(videoPlayer, videoFile, picFile);
            break 
		case "u4.10": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo410); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,..255. , off: 5555): ","3", "visible","visible","MP1 + Mp2-Quant-Faktor: ","2","visible","visible","HP-Quant-Faktor: ","1");
			setImputFields4("visible","visible","Gain Sumant: ","100");
			loadPlayer(videoPlayer, videoFile, picFile);
            break 
		case "u4.11": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo411); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,..255. , off: 5555): ","3", "visible","visible","MP1 + Mp2-Quant-Faktor: ","2","visible","visible","HP-Quant-Faktor: ","1");
			setImputFields4("visible","visible","Gain Sumant: ","100");
			loadPlayer(videoPlayer, videoFile, picFile);
            break 
		case "u4.12": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo412); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,..255. , off: 5555): ","3", "visible","visible","MP1 + Mp2-Quant-Faktor: ","2","visible","visible","HP-Quant-Faktor: ","1");
			setImputFields4("visible","visible","Gain Sumant: ","100");
			loadPlayer(videoPlayer, videoFile, picFile);
            break 
		case "u4.13": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo413); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,..255. , off: 5555): ","3", "visible","visible","MP1 + Mp2-Quant-Faktor: ","2","visible","visible","HP-Quant-Faktor: ","1");
			setImputFields4("visible","visible","Gain Sumant: ","100");
			loadPlayer(videoPlayer, videoFile, picFile);
            break 
		case "u4.14": 
			setMainVideoPlayer(display_fac,display_fac,processingVideo414); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,..255. , off: 5555): ","3", "visible","visible","MP1 + Mp2-Quant-Faktor: ","2","visible","visible","HP-Quant-Faktor: ","1");
			setImputFields4("visible","visible","Gain Sumant: ","100");
			loadPlayer(videoPlayer, videoFile, picFile);
            break 
		...
		case "u11.1": 
			...
			setMainAudioPlayer("Gen",1,sampleRate,processingAudioGenSinus); //l�sung  Audio 1.1 
            break 
		case "u11.2": 
			setImputFields("hidden","hidden","???: ","1", "hidden","hidden","???: ","1", "hidden","hidden","?????: ","1");
			setMainAudioPlayer("Aud",1,1024,processingAudioMono); //l�sung  Audio 1.1 
			loadPlayer(audioPlayer, audioFile, picFile);
            break 	
		case "u11.10": 
		...
		case "u12.3": 
			...
			setMainAudioPlayer("Aud",1,1024*16,processingAudioDelay);  //l�sung 2
			loadPlayer(audioPlayer, audioFile, picFile);
            break 
		case "u12.3a": 
			setImputFields("visible","visible","Delay dB(-96 bis +12): ","-2", "hidden","hidden","DealyTime(-16k bis 16k): ","16000", "hidden","hidden","?????: ","1");
			setMainAudioPlayer("Aud",1,1024*16,processingAudioDelay16K);  //l�sung 2
			loadPlayer(audioPlayer, audioFile, picFile);
            break 
		case "u12.3b": 
			...
			setMainAudioPlayer("Gen",1,8,processingAudioGenDelay);  //l�sung 2
            break 			
		case "u12.4": 
			setImputFields("visible","visible","Type(1-1000): ","2", "hidden","hidden","???: ","1", "hidden","hidden","?????: ","1");
		...
		case "u12.9": 
            ...
            break 
		case "u13.1": 
			setMainAudioPlayer("Gen",1,8,processingAudioGenKompDelta); //l�sung  3.1 
			...
			break  			
		case "u13.2": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudioKompDelta); //l�sung  3.1 
            ...
            break 
		case "u13.3": 
			setMainAudioPlayer("Gen",1,8,processingAudioGenKompSubband); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","1", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			break  			
		case "u13.4": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudioKompSubband); //l�sung  3.1 
            ...
            break 
		case "u13.5": 
			setMainAudioPlayer("Gen",1,8,processingAudioGenKompFFT); //l�sung  3.1 
			...
			break  			
		case "u13.6": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudioKompFFT); //l�sung  3.1 
            ...
            break			
		case "u13.5a": 
			setMainAudioPlayer("Gen",1,1024*8,processingAudioGenWhiteNoiseKompFFT); //l�sung  3.1 
			setImputFields("visible","visible","TP-Quant-Faktor(1,2,4,8,16,.. 24 Bit. , off: 88888888): ","66000", "visible","visible","HP-Quant-Faktor: ","18888888", "visible","visible","Grenzfreq.(1-16000/2 Hz): ","1000");
			break  			
		case "u14.1": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio41); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.2": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio42); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);	
			break  
		case "u14.3": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio43); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.4": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio44); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.5": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio45); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.6": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio46); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.7": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio47); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.8": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio48); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.9": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio49); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.10": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio410); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.11": 
			...
			break  
		case "u14.12": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio412); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.13": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio413); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		case "u14.14": 
			setMainAudioPlayer("Aud",1,1024*16,processingAudio414); //l�sung  3.1 
			setImputFields("visible","visible","Quant-Faktor(1,2,4,8,16,..4096. , off: 66000): ","64", "hidden","hidden","HP-Quant-Faktor: ","1", "hidden","hidden","Grenzfreq.(Hz): ","1");
			loadPlayer(audioPlayer, audioFile, picFile);		
			break  
		default: 
